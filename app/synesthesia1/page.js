...
export default function Synesthesia1Page() {
  return (
    <Layout>
      ...
      <p>For the technicalities involved in the creation of this video, I&apos;ll defer to posts I&apos;ll be writing in <Link href="/">the blog</Link>.</p>
