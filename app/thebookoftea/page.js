...
export default function TheBookOfTeaPage() {
  ...
  return (
    <Layout>
      ...
      <div className="article-text">
        ...
        <ul>
          <li>
            <Link href="/synesthesia1/">Synesthesia #1</Link> was produced by
          ...
          <li>
            <Link href="/abluedwarftale/">Synesthesia #2</Link>: this one was
          ...
          <li>
            <Link href="/firstflight/">Synesthesia #3</Link>: the third
