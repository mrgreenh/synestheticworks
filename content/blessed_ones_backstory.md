---
slug: "/blog/blessed_ones_backstory"
date: "2024-09-01"
title: "The Blessed Ones Series - Background Story"
summary: "An imaginary galaxy where a super-intelligent AI divides all life forms into two groups: the Blessed Ones, and everyone else. The backstory behind the Granting Voice series of VJ loops."
ogimage: "/nfts/portal_peaks_daytime.jpg"
---

This is the story I've used as inspiration for the art in the Blessed Ones series. You can [see the art on the VJ loops page](/vj-loops).

There was once a hyper-technological civilization that had managed to build a self-improving AI which was given the goal of granting the wishes of any living being matching their DNA signature. Over time, this intelligence had become so powerful, almost any dream imaginable could be fulfilled. It had optimized its interface to be almost completely invisible through the use of nanotechnologies: it was sufficient for one to whisper their desires in the air, for the AI to take notice and put its cosmic supply-chain into motion for its fulfillment. Elegant holograms would be thinly drawn mid-air in sign of acknowledgement, food and gifts would simply float down from the sky, buildings would be assembled into place as if their components were moved into place by ghosts.

[![Harvester](/nfts/harvester_full.png)](/art/harvester/)

This civilization however disappeared for unknown reasons, leaving behind only a small number of their biological descendants, that will soon become known in the rest of the galaxy as the "Blessed Ones". Over just a few generations of technological collapse, tribes of these now primitive beings had lost all the knowledge and culture of their ancestors. There was however something left behind: the AI system had survived, and was still listening. It now only understood, however, a dead ancient language.
...
The visual art from the "Granting Voice" series takes place in this galaxy, sampling sights from either side of the creative and destructive forces of this intelligence.
