        ...
        <div className="bookings_intro">
            <div className="framed">
                ...
                <MediaPlayer
                    ...
                    controls={false}
                ></MediaPlayer>
                <div className="text_with_gradient">
                    ...
                    All visuals are original works created by me, and procedurally blended to closely represent music through a custom software I'm currently developing, inspired by <Link href="/synesthesia1">synesthesia</Link>.<br />
                    <br />
                    - <Link href="/about"><i>Synwrks</i></Link>
                </div>
            </div>
        </div>
    );
